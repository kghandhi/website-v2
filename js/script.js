(function ($) {
    ...
    function mouseParallax(id, left, top, mouseX, mouseY, speed) {
        ...
        obj.style.left = left - (((mouseX - (parseInt(obj.offsetWidth, 10) / 2 + left)) / containerWidth) * speed) + 'px';
        obj.style.top = top - (((mouseY - (parseInt(obj.offsetHeight, 10) / 2 + top)) / containerHeight) * speed) + 'px';
    }
    /* ########################################### /hero parallax ############################################## */
